...
QUESTION_MAP_PATH = os.path.join(BASE_DIR, "data", "GroupB", "log", "question_history.json")
CHECKPOINT_DIR = os.path.join(BASE_DIR, "data", "GroupB")
        ...
        if st.button("Submit Evaluation", disabled=disable_inputs):
            eval_record = {
                "EMVS": {
                    ...
                    "causal_correctness": caus, 
                    "causal_completeness": caus_c, 
                    "novelty": inte
                },
